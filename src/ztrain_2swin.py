...
import dataset
from z230606_2Swin_CAF3_ALC import PGNet
...
def parser():
    ...
    parser.add_argument('--savepath', default="../model/z230606_2Swin_CAF3_ALC", type=str)  
    parser.add_argument('--datapath', default="../data/DIS-TR", type=str) 
    parser.parse_args()
