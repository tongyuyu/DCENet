...
class PGNet(nn.Module):
    def __init__(self, cfg=None):
        ...
        aspp_dilate1=[12, 24, 36]
        self.ASPP1 = ASPP(64, aspp_dilate1)
        aspp_dilate2=[12, 24, 36]
        self.ASPP2 = ASPP(64, aspp_dilate2)
        aspp_dilate3=[1, 2, 3]
        self.ASPP3 = ASPP(64, aspp_dilate3)
        aspp_dilate4=[1, 2, 1]
        self.ASPP4 = ASPP(64, aspp_dilate4)
        aspp_dilate5=[1, 2, 1]
        self.ASPP5 = ASPP(64, aspp_dilate5)
        
        
        self.attention5 = IntegralAttention()
        self.attention4 = IntegralAttention()
        self.attention3 = IntegralAttention()
        self.attention2 = IntegralAttention()
        self.attention1 = IntegralAttention()
    ...
    def forward(self, x,shape=None,mask=None):
        ...
        r1_2 = self.ALC1(r1_1)  # 64 248 248
        r2_2 = self.ALC2(r2_1)  # 64 248 248
        r3_2 = self.ALC3(r3_1)  # 64 124 124
        r4_2 = self.ALC4(r4_1)  # 64 62 62
        # print('r5_1.size:',r5_1.size())
        
        r5_2 = self.ALC5(r5_1)  # 64 62 62
        
        r5_3 = r5_2 + r5_1
        # print('r5_4.size():', r5_4.size())
        
        r5_4 = self.RFB5(r5_3)
        # print('r5_4.size():', r5_4.size())
        r5_5 = self.attention5(r5_4)
        r5_6 = torch.mul(r5_4, r5_5)
        # r5_7 = self.upsample2(r5_6)
        
        r4_3 = r4_2 + r4_1 +r5_6
        r4_4 = self.RFB4(r4_3)
        r4_5 = self.attention4(r4_4)
        r4_6 = torch.mul(r4_4, r4_5)
        r4_7 = self.upsample2(r4_6)
        
        r3_3 = r3_2 + r3_1 + r4_7
        r3_4 = self.RFB3(r3_3)
        r3_5 = self.attention3(r3_4)
        r3_6 = torch.mul(r3_4, r3_5)
        r3_7 = self.upsample2(r3_6)
        
        r2_3 = r2_2 + r2_1 + r3_7
        r2_4 = self.RFB2(r2_3)
        r2_5 = self.attention2(r2_4)
        r2_6 = torch.mul(r2_4, r2_5)
        # r2_7 = self.upsample2(r2_6)
        
        
        r1_3 = r1_2 + r1_1 + r2_6           
        r1_4 = self.RFB1(r1_3)
        r1_5 = self.attention1(r1_4)
        r1_6 = torch.mul(r1_4, r1_5)
        
        # print('r1_6.size():', r1_6.size())
        ...
        # 全是64通道，信息可能有损耗
        # r23 = self.conv320_64(r1_6) # 8 64 248 248

        
        pred1 = F.interpolate(self.linear1(r1_6), size=shape, mode='bilinear') 
