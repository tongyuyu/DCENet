...
import dataset
from z240102_Res2Net import PGNet
...
def parser():
    ...
    parser.add_argument('--savepath', default="../model/z240114_Res2Net", type=str)  
    parser.add_argument('--datapath', default="../data/DIS5K/DIS-TR", type=str) 
    parser.parse_args()
