...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, baseWidth=26, scale=4, num_classes=1000,mode='rgb',):
        self.inplanes = 64
...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = torch.load('/media/lab509-1/data/TYY/RGBD-COD/ISM/Res2Net_pth/res2net50_v1b_26w_4s-3cf99910.pth')
